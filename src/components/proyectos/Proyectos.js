          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-center">
                <a href="https://soberanesmajo.github.io/cdmx-2018-06-bc-core-am-data-dashboard/src/index.html" className=""><button type="button" class="btn btn-outline-light">Demo</button></a>
                <a href="https://github.com/soberanesmajo/cdmx-2018-06-bc-core-am-data-dashboard" className=""><button type="button" class="btn btn-outline-light">Código</button></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-center">
                <a href="https://soberanesmajo.github.io/cdmx20181-Track-FE-themovieapi/src/index.html" className=""><button type="button" class="btn btn-outline-light">Demo</button></a>
                <a href="https://github.com/soberanesmajo/cdmx20181-Track-FE-themovieapi" className=""><button type="button" class="btn btn-outline-light">Código</button></a>
              </div>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-center">
                <a href="n" className=""><button type="button" class="btn btn-outline-light">Demo</button></a>
                <a href="n" className=""><button type="button" class="btn btn-outline-light">Código</button></a>
              </div>
            </div>
          </div>
        </div>
